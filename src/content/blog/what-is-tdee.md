...
Your BMR is then multiplied by an **activity factor** to estimate your full TDEE:

| Activity Level | Multiplier | Who It Fits |
|---|---|---|
| Sedentary | × 1.2 | Desk job, minimal movement |
| Lightly Active | × 1.375 | Exercise 1–2 days/week |
...
- **Eat below TDEE** → calorie deficit → fat loss
...
When in doubt, pick the lower activity level. You can always eat a bit more if results stall.
...
The formula gets you close. Real-world data gets you exact.
