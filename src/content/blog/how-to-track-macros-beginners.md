...
Start by calculating your **TDEE (Total Daily Energy Expenditure)**, which is the number of calories your body burns on an average day at your current activity level. Use the [TDEE Calculator](/tdee-calculator/) to get this number. Then adjust based on your goal: subtract 300–500 calories for fat loss, add 200–300 for muscle building, or stay close to TDEE for maintenance. If you need help figuring out your deficit, the [Calorie Deficit Calculator](/calorie-deficit-calculator/) walks you through it step by step.
...
**Protein first.** This is your anchor macro. Aim for **0.7–1g of protein per pound of bodyweight**. If you weigh 160 lbs, that's 112–160g of protein per day. When in doubt, use the [Protein Calculator](/protein-calculator/) to get a personalized recommendation based on your goal. Protein at 4 calories per gram, so 160g of protein = 640 calories already allocated.
...
Use the [Macro Calculator](/macro-calculator/) to generate your complete numbers automatically. It handles all this math for you and adjusts for whether you're cutting, bulking, or maintaining.
