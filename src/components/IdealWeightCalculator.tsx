...
// The active version is IdealWeightCalculator.astro — edit that file instead.
        ...
        <div key={calcKey} ref={resultsRef} className="animate-fade-up space-y-4">
          ...
          <div className="rounded-2xl bg-green-700 p-6 sm:p-8 text-white">
            ...
            <div className="flex items-baseline gap-3 flex-wrap">
              ...
              <span className="result-label text-xl font-semibold">lbs</span>
            </div>
            <p className="result-label mt-2 text-xs">Devine formula (most widely used)</p>
          ...
          <div className="bg-result-bg rounded-2xl border border-green-100 overflow-hidden">
